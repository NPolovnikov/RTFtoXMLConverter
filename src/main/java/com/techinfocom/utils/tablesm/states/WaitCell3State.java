 ...
 */
public class WaitCell3State<AI extends TableParser> extends StateBase<AI> implements TableParser {
    public static final Event IN_CELL = new Event("IN_CELL");
    AgendaBuilder agendaBuilder;

    public WaitCell3State(AI automation, EventSink eventSink, AgendaBuilder agendaBuilder) {
...
//        switch (docEvent) {
//            case PAR:
//                System.err.println("Состояние WaitCell13tate, поймано событие PAR");
...
//    }
    ...
    public void processCommand(RtfCommand rtfCommand) {
        switch (rtfCommand.getCommand()){
            case intbl:
                System.err.println("В состоянии WFcell3 поймали intbl");
                eventSink.castEvent(IN_CELL);
                break;
        }
    }
